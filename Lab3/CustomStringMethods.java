...
public class CustomStringMethods {
    ...
    */
    public String endUp(String myString, int numToCap){
        if (myString.length() - numToCap > 0) {
            String firstHalf = myString.substring(0, myString.length() - numToCap);
            String secondHalf = myString.substring(myString.length() - numToCap);
